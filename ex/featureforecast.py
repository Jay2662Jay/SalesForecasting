...
# === Load data ===
df = pd.read_csv("/Users/jaygamage/Downloads/dataf_c.csv")
...
# === Save to CSV ===
all_forecasts.to_csv('/Users/jaygamage/Downloads/ffcdata.csv', index=False)
print("💾 Saved to: /Users/jaygamage/Downloads/ffcdata.csv")
