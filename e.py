...
# -------- CONFIG --------
TRAIN_PATH = "/Users/jaygamage/Downloads/pt/merged_train_data.csv"
PREDICT_PATH = "/Users/jaygamage/Downloads/pt/merged_prfe_data.csv"
OUTPUT_DIR = "/Users/jaygamage/Downloads/pt/feature_outputs"
...
def main():
    ...
    # ✅ Sort both by date then group_code
    train_fe = train_fe.sort_values(by=["date", "group_code"]).reset_index(drop=True)
    predict_fe = predict_fe.sort_values(by=["date", "group_code"]).reset_index(drop=True)
