...
print("Available columns:", df.columns)  # 👈 Add this to debug
...
for material in df["Material_Group"].unique():
    ...
    future_predictions["Predicted_Advertising_Promotion"] = future_predictions["Predicted_Advertising_Promotion"].clip(
        lower=0)
...
output_path = "/Users/jaygamage/Downloads/adcdata.csv"
