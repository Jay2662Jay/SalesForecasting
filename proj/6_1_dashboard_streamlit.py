...
# -------- PAGE: FEATURE DATA VIEW --------
    ...
    actual_features = pd.read_csv("/Users/jaygamage/Downloads/pt/dataf_c.csv", parse_dates=["date"])
    features_pred = pd.read_csv("/Users/jaygamage/Downloads/pt/ffdata.csv", parse_dates=["date"])
